...
<table>
  <tr>
    <td width="80%">
      ...
      <table>
        <tr>
          <td></td>
          <td><b style="font-size:18px">&emsp;
    ...
    <td>
      ...
      <table>
        <tr>
          <td style="font-size:18px">Driver : <?php if (isset($transfer[0]->driver_s)): ?><?=$karyawan[$transfer[0]->driver_s]->nama?><?php endif; ?></td>
          <td></td>
        </tr>
        <tr>
          <td style="font-size:18px">QC Service : <?php if (isset($transfer[0]->qc_s)): ?><?=$karyawan[$transfer[0]->qc_s]->nama?><?php endif; ?></td>
          <td></td>
        </tr>
      </table>
    </td>
  ...
  <div class="col-md-12">
    ...
    <table>
			<td>Tanggal Kirim: <b><?=tanggal($transfer[0]->tanggal_proses)?></b><br>
			Dari Gudang: <b>Service</b><br><br><br></td>
