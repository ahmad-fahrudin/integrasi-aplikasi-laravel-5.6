    ...
    <div class="page-wrapper">
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">
                      <nav aria-label="breadcrumb">
                          <ol class="breadcrumb ">
                              <li class="breadcrumb-item text-muted" aria-current="page">Keuangan > <a href="https://stokis.app/?s=transaksi+keluar+masuk+kas+di+tangan" target="_blank">Kas di Tangan</a></li>
                          </ol>
                      </nav>
                    </h4>
                    <div class="col-md-4">
                      <form action="{{url('proseskasditangan')}}" method="post" id="form_proseslabarugi" onsubmit="return validateForm()" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                              <div class="row">
                                  <div class="col-md-12">
                                      <input id="saldo" name="old_saldo" required type="text" readonly class="form-control" value={{ribuan(cek_kas_ditangan())}}>
                                  </div>
                              </div>
                          </div>
                        </div>
                        ...
                        <br>
                        Kategori Transaksi:
                        <select name="nama_jenis" id="catatan" required class="form-control" onchange="CekBank()">
                          <option>Modal</option>
                          ...
                          <option hidden>Ambil dari Bank</option>
                    ...
                    <form action="{{url('kasditangan')}}" method="post">
                      {{csrf_field()}}
                  ...
                  <div class="row">
                    ...
                    <label class="col-lg-0.5">Kategori Transaksi</label>
                    <div class="col-md-2">
                      <div class="row">
                        <div class="col-md-12">
                          <?php if (isset($jenis) && $jenis == "in"){ ?>
                            <select name="nama_jenis" id="catatan_filter" class="form-control">
                              ...
                              <option <?php if ($nama_jenis == "Pembiayaan"): ?>selected<?php endif; ?>>Pembiayaan</option>
                              ...
                              <option  <?php if ($nama_jenis == "Ambil dari Bank"): ?>selected<?php endif; ?>>Ambil dari Bank</option>
                              <option  <?php if ($nama_jenis == "Pembiayaan"): ?>selected<?php endif; ?>>Pembiayaan / Hutang</option>
                              <option  <?php if ($nama_jenis == "PPN"): ?>selected<?php endif; ?>>PPN</option>
                              <option  <?php if ($nama_jenis == "Hutang"): ?>selected<?php endif; ?>>Hutang</option>
                            </select>
                          <?php }else if(isset($jenis) && $jenis == "out"){ ?>
                            <select name="nama_jenis" id="catatan_filter" class="form-control">
                              <option value="">Semua</option>
                              <option <?php if ($nama_jenis == "Pengadaan Barang"): ?>selected<?php endif; ?>>Pengadaan Barang</option>
                              <option <?php if ($nama_jenis == "Beban Operasional"): ?>selected<?php endif; ?>>Beban dan Operasional</option>
                              ...
                              <option <?php if ($nama_jenis == "Prive Modal"): ?>selected<?php endif; ?>>Prive Modal Pemilik</option>
                              ...
                              <option <?php if ($nama_jenis == "Simpan di Bank"): ?>selected<?php endif; ?>>Simpan di Bank</option>
                              <option <?php if ($nama_jenis == "Bayar PPN"): ?>selected<?php endif; ?>>Bayar PPN</option>
                              <option <?php if ($nama_jenis == "Bayar Hutang"): ?>selected<?php endif; ?>>Bayar Hutang</option>
                          ...
                          <?php }else{ ?>
                            <select name="nama_jenis" id="catatan_filter" class="form-control">
                              ...
                              <option>Setoran Jasa</option>
                              <option>Pemasukan Lain - Lain</option>
                              <option>Ambil dari Bank</option>
                              <option>Pembiayaan / Hutang</option>
                            </select>
                          <?php } ?>
                        </div>
                      </div>
                ...
                <div class="form-group">
                  ...
                  <table id="labarugi_table" class="table table-striped table-bordered no-wrap" style="width:100%">
                      ...
                      <tbody>
                        <?php $no=1; $jumlah=0; foreach ($kasditangan as $key => $value): ?>
                          <tr>
      ...
      function Catatan(){
        ...
        if (cek == "out") {
          ...
          var x6 = document.createElement("OPTION");
          var t6 = document.createTextNode("Ambil dari Bank");
          x6.appendChild(t6);
          document.getElementById("catatan").appendChild(x6);
          
          var x7 = document.createElement("OPTION");
          var t7 = document.createTextNode("Pembiayaan");
          x7.appendChild(t7);
          document.getElementById("catatan").appendChild(x7);
          
          var x8 = document.createElement("OPTION");
          var t8 = document.createTextNode("PPN");
          x8.appendChild(t8);
          document.getElementById("catatan").appendChild(x8);
          
          var x9 = document.createElement("OPTION");
          var t9 = document.createTextNode("Hutang");
          x9.appendChild(t9);
          document.getElementById("catatan").appendChild(x9);
          
          var x10 = document.createElement("OPTION");
          var t10 = document.createTextNode("Revisi");
          x10.appendChild(t10);
          document.getElementById("catatan").appendChild(x10);
        }
      }
      ...
      <script>
          ...
          function CekBank(){
            var ck = document.getElementById("catatan").value;
            if (ck == "Simpan di Bank") {
