        ...
        <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="card-body">
                    <h4 class="card-title">
                      <nav aria-label="breadcrumb">
                          <ol class="breadcrumb ">
                             <li class="breadcrumb-item text-muted" aria-current="page">Laporan Harian / Trip > <a href="https://stokis.app/?s=pengelompokan+trip+laporan+jasa" target="_blank">Pengelompokan Lap. Jasa</a></li>
                          </ol>
                      </nav>
                    </h4>
                    <hr>
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          ...
                          <div class="col-lg-9">
                              <div class="row">
                                  <div class="col-md-11">
                                      <input type="date" id="tanggal_input" value="{{date('d-m-Y')}}" class="form-control">
                                  </div>
                              </div>
                          </div>
                        </div>
                        <br>
                        <div class="row">
                          <label class="col-lg-3">No. Trip Jasa</label>
                          <div class="col-lg-9">
                              <div class="row">
                                  <div class="col-md-11">
                                      <input type="text" id="no_trip" value="TJ-{{date('ymd').$number}}" class="form-control">
                                  </div>
                              </div>
                          </div>
                        </div>
                              ...
                              <div class="row">
                                  <div class="col-md-11">
                                    <div class="input-group">
                                      <input id="driver" type="text" class="form-control" placeholder="Pilih Kasir" readonly style="background-color:#fff">
                        ...
                        <div class="col-md-6">
                          <div class="row">
                            <label class="col-lg-6"><strong>Layanan Jasa</strong></label>
                          </div>
                          <br>
                          <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="row">
                                    <div class="col-md-11">
                                      <div class="input-group">
                                        <input id="id_barang"  type="text" class="form-control" placeholder="Pilih kwitansi" readonly style="background-color:#fff">
                          ...
                          <!--div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="row">
                                    <div class="col-md-12">
                                      <div class="input-group">
                                        <input id="id_barang"  type="text" class="form-control" placeholder="Ketik No. Kwitansi Jasa...">
                                        <input id="valbarang" type="hidden" class="form-control">
                                        <div class="input-group-append">
                            ...
                            <div class="col-lg-9">
                                <div class="row">
                                    <div class="col-md-11">
                                        ...
                                        <input id="id_konsumen" name="id_konsumen" type="hidden" class="form-control">
                                    </div>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="row">
                                    <div class="col-md-11">
                                        <input id="alamat" name="jumlah" type="text" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="row">
                                    <div class="col-md-11">
                                        <input id="sub_total" name="jumlah" type="text" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                          </div>
                ...
                <br>
                Nilai Layanan Jasa : <b id="nilai_penjualan">0</b>
                <center>
                  <button onclick="Simpan()" id="save" disabled class="btn btn-success btn-lg">Simpan</button>
                  <button onclick="CetakSuratJalan()" id="cetakkwitansi" disabled class="btn btn-warning btn-lg">Cetak Surat Jalan</button>
                  </center><br>
              </div>
            </div>
          </div>
...
<div class="modal fade" id="suplayer" role="dialog">
  ...
  <div class="modal fade" id="drv" role="dialog">
              ...
              <div class="modal-body">
                ...
                <table id="examples3" class="table table-striped table-bordered no-wrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      if ($value->tagihan > 0){ ?>
                        <tr id="{{$value->no_kwitansi}}" onclick="pilihbarang('{{$value->id_tripost}}','{{$value->no_kwitansi}}','{{$konsumen[$value->id_konsumen]['nama']}}','<?=$konsumen[$value->id_konsumen]['alamat']?>','{{$value->tagihan}}','{{$value->id_konsumen}}','{{$value->potongan}}')">
    ...
    function pilihbarang(id_tripost,no_kwitansi,nama,alamat,tagihan,id_konsumen,potongan){
      ...
      var has = Number(tagihan) - Number(potongan);
      
      document.getElementById("sub_total").value = numberWithCommas(has);
    ...
    function tambah(){
      ...
      if(kw.includes(no_kwitansi)){
        ...
        if (id_tripost != "") {
          ...
          cell5.innerHTML = '<button class="btn btn-default" onclick="deletecart('+lastRow+','+sub_total+')"><i class="icon-trash"></i></button>';
    ...
    function Simpan(){
      ...
      if (tanggal_input != "" && driver != "") {
        ...
        $.post("trippostjasa",
          {tanggal_input:tanggal_input, id_gudang:id_gudang, kasir:driver, admin:admin,
            id_barang_keluar:upidbarangkeluar, no_kwitansi:upnokwitansi, id_konsumen:upidkonsumen, sub_total:upsubtotal
        ...
        $.ajax({
           ...
           success: function(response){
             if (response.length > 0) {
               ...
               alamat = alamat.replace('</p>','');
               document.getElementById("alamat").value = alamat;
               document.getElementById("sub_total").value = numberWithCommas(response[0]['tagihan']-response[0]['potongan']);//
