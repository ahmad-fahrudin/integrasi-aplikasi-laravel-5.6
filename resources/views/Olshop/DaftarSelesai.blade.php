              ...
              <div class="card-body">
                <h4 class="card-title">
                  <nav aria-label="breadcrumb">
                      <ol class="breadcrumb ">
                          <li class="breadcrumb-item text-muted" aria-current="page">Gudang > Orderan Web Store > <a href="https://stokis.app/?s=data+order+terkirim+web+store" target="_blank">Order Terkirim</a></li>
                      </ol>
                  </nav>
                </h4>
                <hr>
              ...
              <table id="example" class="table table-striped table-bordered no-wrap" style="width:100%">
                  ...
                  <tbody>
                    <?php foreach ($order as $value) {
                      ...
                      ?>
                      <tr
                      <?php if ($value->transaction_status != "Lunas"): ?>
                      ...
                      <?php endif; ?> >
                          ...
                          <td>
                            ...
                            <a class="btn btn-success" href="{{url('lacak_kurir')}}/{{$value->no_kwitansi}}">Detail Pengiriman</a>
