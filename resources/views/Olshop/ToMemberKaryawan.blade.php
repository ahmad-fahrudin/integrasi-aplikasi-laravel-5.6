              ...
              <div class="card-body">
                <h4 class="card-title">
                  <nav aria-label="breadcrumb">
                      <ol class="breadcrumb ">
                          <li class="breadcrumb-item text-muted" aria-current="page">SDM > Karyawan > <a href="https://stokis.app/?s=akun+member+karyawan" target="_blank">Buat Akun Member Area</a></li>
                      </ol>
                  </nav>
                </h4>
                <hr>
                <label><h4>Data Karyawan (Non Member)</h4></label>
                <br><br>
              ...
              <table id="example" class="table table-striped table-bordered no-wrap" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$value->no_hp}}</td>
                        <td>
                            <button onclick="Approve('{{$value->id}}','{{$value->nama}}')" class="btn btn-primary">Buat Akun Member</button>
                        </td>
                    </tr>
                    <?php $no++; } ?>
                  </tbody>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <br>
            <form action="{{url('simpantomemberkaryawan')}}" method="post">
            {{csrf_field()}}
            Email
            ...
            <b class="text-danger" id="notemail" hidden>Email Sudah Terdaftar!</b>
