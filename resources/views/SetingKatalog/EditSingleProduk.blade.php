                    ...
                    <div class="col-md-8 m-auto">
                      <form action="{{url('updatekatalog')}}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="input-group">
                          <input id="nama_barang_single" value="{{$produk[0]->nama_barang}}" type="text" name="nama_barang" class="form-control" placeholder="Pilih Barang (icon folder) --->">
                          <div class="input-group-append">
                              <button class="btn btn-outline-secondary" onclick="caribarang()" type="button"><i class="fas fa-folder-open"></i></button>
                          </div>
                        </div>
                        <br>
                        <input id="id_barang" type="hidden" name="barang" value="{{$produk[0]->barang}}" class="form-control">
                        <input id="id_barang_old" type="hidden" name="barang_old" value="{{$produk[0]->barang}}" class="form-control">
                        Berat Produk:
                        <input id="berat" name="berat" type="number" step="0.1" value="{{$produk[0]->berat}}" class="form-control" placeholder="Berat Produk (Kg), Ex: 1.5">
                        <input id="id_single" name="id" type="hidden" class="form-control" value="{{$produk[0]->id}}">
                        <br>
                        Kategori Produk:
                        ...
                        $i=1; foreach ($color as $key => $value): ?>
                          <fieldset class="checkbox">
                              <label><input type="checkbox" name="warna{{$i}}" id="{{$value->hex}}" value="{{$value->hex}}"
                        ...
                        <div id="gbr"></div>
                        <br><a onclick="AddImage()" class="btn btn-primary btn-sm" style="color:white;">Tambah Gambar Lagi</a>
                        <br><br>
                        <center>
