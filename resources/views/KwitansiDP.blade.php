    ...
    <table>
      <tr>
        ...
        <td align="right" style="letter-spacing:1px">
          <h4><b>INVOICE BAYAR DIMUKA</b></h4>
  ...
  <div class="col-md-12">
    <table id="content" style="font-size:18px">
	  ...
	  <tr>
        ...
        <td align="right"></td>
        <?php } ?>
        <td hidden align="left"><h5>Ongkir</h5></td>
        <td hidden align="right" style="letter-spacing:1px"><b>{{rupiah($ongkos_kirim)}}</b></td>
      </tr>
      ...
      <tr>
        ...
        <td align="right"></td>
        <?php } ?>
        <td hidden align="left"><h5>BAYAR</h5></td>
        <td hidden align="right" style="letter-spacing:2px"><h4>{{rupiah($total+$ongkos_kirim)}}</h4></td>
      </tr>
    </table>
		<?php if ($no < 11){
			for($x=0; $x < (11-$no) ; $x++){
    ...
    <div class="row">
      <table>
        <tr>
          ...
          <b>Tanggal: {{date('d-m-Y')}}</b><br><br>
            <b>&emsp;Catatan :</b> 
            <ol>
                <li>
                 Ini sebagai bukti pembayaran dimuka   
                </li>
                <li>
                 <b>Barang Belum Dikirim (status PO)</b>   
                </li>
                <li>
                 Setelah barang dikirim akan dibuatkan <br><b>Surat Penyerahan Barang</b> baru.   
                </li>
            </ol>
          </div>
          <td style="letter-spacing:1px">
          ...
          <td style="letter-spacing:1px">
            <b><center><h5>Konsumen</h5></center></b>
            <br>
            <center>(&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;)</center>
          </td>
        </tr>
