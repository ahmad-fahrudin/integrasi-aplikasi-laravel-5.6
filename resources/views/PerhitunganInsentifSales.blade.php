...
if ($value->harga_jual - (($value->sub_potongan/$terkirim) + $value->potongan)  >= $value->harga_net) {
    $itung = ($value->sub_total - ($value->harga_hpp * $value->terkirim));
    $itunga = persenfee()[1]->itung_a/100 * $itung;
    $itungb = persenfee()[1]->itung_b/100 * $itung;
  ...
  if ($value->harga_jual - (($value->sub_potongan/$terkirim) + $value->potongan) > $value->harga_hp){
    ...
    $itunga = (persenfee()[1]->itung_a/2)/100 * $itung;
    $itungb = (persenfee()[1]->itung_b/2)/100 * $itung;
    ...
    $itunga = (persenfee()[1]->itung_a/2)/100 * $itung;
    $itungb = (persenfee()[1]->itung_b/2)/100 * $itung;
    $bagihasilstokis +=(persenfee()[1]->stokis/2)/100 * $itung;
  }
...
//end adc
//adc konsumen Distributor referal Pengembang
                      ...
                      <?php if (isset($data)): ?>
                        <?php
                          ...
                          <tr>
                            ...
                            <td hidden align="right"><?php if (isset($value['referal'])) {
                            ...
                            <td hidden align="right"><?php if (isset($value['reseller'])) {
                            ...
                            <td hidden align="right"><?php if (isset($value['agen'])) {
                            ...
                            <td hidden align="right"><?php if (isset($value['distributor'])) {
